...
?>
    <div class="alert alert-info">
        <strong>Запись изменена. </strong><a href="itemsAdmin"> Список блюд</a>
    </div>
    <?php
        }
    else if($test==false)
    {
        ?>
            <div class="alert alert-warning">
                <strong>Ошибка изменения записи!</strong> <a href="itemsAdmin"> Список блюд</a>
            </div>
        <?php
    }
 }
     ...
     ?>
     <form method='POST' action="itemsEditResult?id=<?php echo $id; ?>" enctype="multipart/form-data">
