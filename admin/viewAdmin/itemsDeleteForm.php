...
?>
    <div class="alert alert-info">
        <strong>Запись удалена. </strong><a href="itemsAdmin"> Список блюд</a>
    </div>
    <?php
        }
    else if($test==false)
    {
        ?>
            <div class="alert alert-warning">
                <strong>Ошибка удаления записи!</strong> <a href="itemsAdmin"> Список блюд</a>
            </div>
        <?php
    }
 }
     ...
     ?>
     <form method='POST' action="itemsDelResult?id=<?php echo $id; ?>" enctype="multipart/form-data">
